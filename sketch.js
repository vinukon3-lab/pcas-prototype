...
const scenarios = [
    { id: 1, pedSpeed: 0, pedYStart: 0, pedDirection: 0, desc: "Static Pedestrian Center", detail: "Standing still at y=0m - direct path" },
    { id: 2, pedSpeed: 1.67, pedYStart: -5, pedDirection: 1, desc: "Pedestrian Crossing Into Path", detail: "Moving at 6 kph from y=-5m toward vehicle" },
    { id: 3, pedSpeed: 1.67, pedYStart: 5, pedDirection: -1, desc: "Pedestrian Moving Away", detail: "Moving at 6 kph from y=5m away from path" },
    { id: 4, pedSpeed: 1.67, pedYStart: -7, pedDirection: 1, desc: "Pedestrian Far Left Entry", detail: "Moving at 6 kph from y=-7m into path" },
    { id: 5, pedSpeed: 1.67, pedYStart: 7, pedDirection: 1, desc: "Pedestrian Far Right Entry", detail: "Moving at 6 kph from y=7m into path" },
    { id: 6, pedSpeed: 0, pedYStart: -2, pedDirection: 0, desc: "Static Pedestrian Left Side", detail: "Standing still at y=-2m near path edge" },
    { id: 7, pedSpeed: 0, pedYStart: 2, pedDirection: 0, desc: "Static Pedestrian Right Side", detail: "Standing still at y=2m near path edge" },
    { id: 8, pedSpeed: 3.33, pedYStart: -3, pedDirection: 1, desc: "Fast Pedestrian Crossing", detail: "Moving at 12 kph from y=-3m (maximum speed)" },
    { id: 9, pedSpeed: 1.67, pedYStart: 0, pedDirection: 1, desc: "Pedestrian At Center Moving", detail: "Moving at 6 kph starting from y=0m" },
    { id: 10, pedSpeed: 0.833, pedYStart: -6, pedDirection: 1, desc: "Slow Pedestrian Crossing", detail: "Moving at 3 kph from y=-6m (slow crossing)" },
    { id: 11, pedSpeed: 0, pedYStart: 0, pedDirection: 0, desc: "Custom Scenario", detail: "User-defined pedestrian speed and distance", isCustom: true }
];
